...
from data import OST, RetriTask, ZSTask, MST
from methods import FT, LwF, IMM, GeoDL
...
if __name__ == '__main__':
    ...
    parser.add_argument('--method', required=True, choices=["ft", "lwf", "geodl", "imm", "rkr", "vrd"])
    parser.add_argument('--part', required=True, choices=["wm", "io", "to"])
    parser.add_argument('--update_img', type=str, default='/media/disk1/yxding/CLIP_Incremental/COCO_Crop_Obj/coco_obj/')
